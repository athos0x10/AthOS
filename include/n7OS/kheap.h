...
/**
 * @brief Permet d'initaliser kheap
 */
void init_kheap();
...
/**
 * @brief Alloue une zone mémoire de taille sz, le résultat sera fourni dans
 * phys.
 *
 * @param sz        Taille de la zone mémoire à allouer
 * @param phys      Adresse de début de la zone allouée. Doit être un pointeur
 * valide de type uint32_t
 * @return uint32_t Adresse de début de la zone allouée
 */
uint32_t kmalloc_p(uint32_t sz, uint32_t *phys);

/**
 * @brief Alloue une zone mémoire de taille sz, alignée sur une page; le
 * résultat sera fourni dans phys.
 *
 * @param sz        Taille de la zone mémoire à allouer
 * @param phys      Adresse de début de la zone allouée. Doit être un pointeur
 * valide de type uint32_t
...
/**
 * @brief Fonction d'allocation d'une zone mémoire générique (pas d'alignement
 * mémoire, le résultat est l'adresse de la zone)
 *
 * @param sz        Taille de la zone mémoire à allouer
 * @return uint32_t Adresse de début de la zone allouée
 */
