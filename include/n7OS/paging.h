...
/**
 * @brief Cette fonction initialise le répertoire de page, alloue les pages de
 * table du noyau et active la pagination.
 *
 */
...
/**
 * @brief Cette fonction alloue une page de la mémoire physique à une adresse de
 ...
 * @param is_kernel     Si is_kernel == 1, la page ne peut être accédée que par
 * le noyau
