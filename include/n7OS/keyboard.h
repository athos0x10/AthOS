/**
 * @file keyboard.h
 * @author Arthur / Jerome
 * @brief This file contains the definitions and functions for the keyboard
 * driver in n7OS. It provides an interface for initializing the keyboard and
 * reading keystrokes from the user.
 * @version 0.1
 * @date 2026-04-20
 *
...
/**
 * @brief Initializes the keyboard driver. This function sets up the necessary
 * hardware
 *
 */
void init_keyboard();
